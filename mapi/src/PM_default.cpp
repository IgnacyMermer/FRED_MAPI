...
string PM_default::processInputMessage(string input) {
    ...
    if(endpoint=="TRG_SETTINGS"){
        ...
        if(endpoint[endpoint.length()-1]=='1'){
            lastNumber="0D";
        }
        else if(endpoint[endpoint.length()-1]=='2'){
            lastNumber="0F";
        }
        else if(endpoint[endpoint.length()-1]=='3'){
            lastNumber="11";
        }
        else if(endpoint[endpoint.length()-1]=='4'){
            lastNumber="13";
        }
        else if(endpoint[endpoint.length()-1]=='5'){
            lastNumber="15";
        }
        else if(endpoint[endpoint.length()-1]=='6'){
            lastNumber="17";
        }
        else if(endpoint[endpoint.length()-1]=='7'){
            lastNumber="19";
        }
        else if(endpoint[endpoint.length()-1]=='8'){
            lastNumber="1B";
        }
        else if(endpoint[endpoint.length()-1]=='9'){
            lastNumber="1D";
        }
        else if(endpoint[endpoint.length()-1]=='A'){
            lastNumber="1F";
        }
        else if(endpoint[endpoint.length()-1]=='B'){
            lastNumber="21";
        }
        else if(endpoint[endpoint.length()-1]=='C'){
            lastNumber="23";
        }
    ...
    else if(endpoint=="TRIGGER_SINGLE_VALUE"){
