...
string ResetErrors::processInputMessage(string input) {
    ...
    if(input=="GBT"){
        ...
        Print::PrintInfo(std::to_string(tcm.act.forceLocalClock));
        if(tcm.act.forceLocalClock==1){
            sequence = "reset\n0x0010000000F00000C00,write\nread";
        }
        else{
            Print::PrintInfo("tutaj");
        ...
        sequence="reset\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n0x002000000D8FFFFFFFF,write\n0x003000000D800000400,write\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n";
        return sequence;
    }
    else if(input=="BITS_RESET"){
        sequence="reset\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n0x002000000D8FFFFFFFF,write\n0x003000000D800000800,write\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n";
        return sequence;
    }
    else if(input=="RX_RESET"){
        sequence="reset\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n0x002000000D8FFFFFFFF,write\n0x003000000D800002000,write\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n";
        return sequence;
    }
    else if(input=="RESYNC"){
        sequence="reset\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n0x002000000D8FFFFFFFF,write\n0x003000000D800000100,write\n0x002000000D8FFFF00FF,write\n0x003000000D800000000,write\n";
        return sequence;
    }
    else if(input=="CLEAR"){
