    ...
    try{
        ...
        switch(count){
            ...
            if(tcm.temp.delayC!=hexValue||firstTime){
                ...
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/DELAY_C", "set"));
            }
            break;
            case 1:
            if(tcm.temp.delayLaser!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/LASER_DELAY", "set"));
            }
            break;
            case 2:
            if(tcm.temp.boardTemp!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TEMPERATURE", "set"));
            }
            break;
            case 3:
            if(tcm.temp.boardType!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BOARD_TYPE", "set"));
            }
            break;
            case 4:
            if(tcm.temp.actualValues!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BOARD_STATUS", "set"));
            }
            break;
            case 5:
            if(tcm.temp.triggers!=hexValue||firstTime){
                ...
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGERS_OUTPUTS_MODE", "set"));
            }
            break;
            case 6:
            if(tcm.temp.trigger5sign!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_ORA_SIGN", "set"));
            }
            break;
            case 7:
            if(tcm.temp.trigger5rand!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGER5_RAND", "set"));
            }
            break;
            case 8:
            if(tcm.temp.trigger4sign!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_ORC_SIGN", "set"));
            }
            break;
            case 9:
            if(tcm.temp.trigger4rand!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGER4_RAND", "set"));
            }
            break;
            case 10:
            if(tcm.temp.trigger3sign!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_V_SIGN", "set"));
            }
            break;
            case 11:
            if(tcm.temp.trigger3rand!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGER3_RAND", "set"));
            }
            break;
            case 12:
            if(tcm.temp.trigger2sign!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_SC_SIGN", "set"));
            }
            break;
            case 13:
            if(tcm.temp.trigger2rand!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGER2_RAND", "set"));
            }
            break;
            case 14:
            if(tcm.temp.trigger1sign!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_C_SIGN", "set"));
            }
            break;
            case 15:
            if(tcm.temp.trigger1rand!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRIGGER1_RAND", "set"));
            }
            break;
            case 16:
            ...
            if(tcm.temp.pmA0Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM_LINK_A0", "set"));
            }
            break;
            case 22:
            if(tcm.temp.pmA1Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM_LINK_A1", "set"));
            }
            break;
            case 23:
            if(tcm.temp.pmA2Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM2A", "set"));
            }
            break;
            case 24:
            if(tcm.temp.pmA3Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM3A", "set"));
            }
            break;
            case 25:
            if(tcm.temp.pmA4Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM4A", "set"));
            }
            break;
            case 26:
            if(tcm.temp.pmA5Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM5A", "set"));
            }
            break;
            case 27:
            if(tcm.temp.pmA6Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM6A", "set"));
            }
            break;
            case 28:
            if(tcm.temp.pmA7Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM7A", "set"));
            }
            break;
            case 29:
            if(tcm.temp.pmA8Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM8A", "set"));
            }
            break;
            case 30:
            if(tcm.temp.pmA9Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM9A", "set"));
            }
            break;
            case 31:
            if(tcm.temp.pmC0Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM0C", "set"));
            }
            break;
            case 32:
            if(tcm.temp.pmC1Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM1C", "set"));
            }
            break;
            case 33:
            if(tcm.temp.pmC2Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM2C", "set"));
            }
            break;
            case 34:
            if(tcm.temp.pmC3Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM3C", "set"));
            }
            break;
            case 35:
            if(tcm.temp.pmC4Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM4C", "set"));
            }
            break;
            case 36:
            if(tcm.temp.pmC5Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM5C", "set"));
            }
            break;
            case 37:
            if(tcm.temp.pmC6Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM6C", "set"));
            }
            break;
            case 38:
            if(tcm.temp.pmC7Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM7C", "set"));
            }
            break;
            case 39:
            if(tcm.temp.pmC8Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM8C", "set"));
            }
            break;
            case 40:
            if(tcm.temp.pmC9Status!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/PM9C", "set"));
            }
            break;
            case 41:
            if(tcm.temp.delayA!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/DELAY_A", "set"));
            }
            break;
            case 42:
            if(tcm.temp.vtimeLow!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/VTIME_LOW", "set"));
            }
            break;
            case 43:
            if(tcm.temp.vtimeHigh!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/VTIME_HIGH", "set"));
            }
            break;
            case 44:
            if(tcm.temp.scLevelA!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SC_LEVEL_A", "set"));
            }
            break;
            case 45:
            if(tcm.temp.scLevelC!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SC_LEVEL_C", "set"));
            }
            break;
            case 46:
            if(tcm.temp.cLevelA!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/C_LEVEL_A", "set"));
            }
            break;
            case 47:
            if(tcm.temp.cLevelC!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/C_LEVEL_C", "set"));
            }
            break;
            case 48:
            if(tcm.temp.mainPanelBits!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/MODES_STATUS", "set"));
            }
            break;
            case 49:
            if(tcm.temp.sideAStatus!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SIDE_A_STATUS", "set"));
            }
            break;
            case 50:
            if(tcm.temp.sideCStatus!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SIDE_C_STATUS", "set"));
            }
            break;
            case 51:
            if(tcm.temp.countersUpdRate!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/COUNTERS_UPD_RATE", "set"));
            }
            break;
            case 52:
            if(tcm.temp.bkgrnd0Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND0_CNT", "set"));
            }
            break;
            case 53:
            if(tcm.temp.bkgrnd1Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND1_CNT", "set"));
            }
            break;
            case 54:
            if(tcm.temp.bkgrnd2Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND2_CNT", "set"));
            }
            break;
            case 55:
            if(tcm.temp.bkgrnd3Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND3_CNT", "set"));
            }
            break;
            case 56:
            if(tcm.temp.bkgrnd4Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND4_CNT", "set"));
            }
            break;
            case 57:
            if(tcm.temp.bkgrnd5Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND5_CNT", "set"));
            }
            break;
            case 58:
            if(tcm.temp.bkgrnd6Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND6_CNT", "set"));
            }
            break;
            case 59:
            if(tcm.temp.bkgrnd7Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND7_CNT", "set"));
            }
            break;
            case 60:
            if(tcm.temp.bkgrnd8Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND8_CNT", "set"));
            }
            break;
            case 61:
            if(tcm.temp.bkgrnd9Cnt!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BKGRND9_CNT", "set"));
            }
            break;
            case 62:
            if(tcm.temp.fpgaTemp!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/FPGA_TEMP", "set"));
            }
            break;
            case 63:
            if(tcm.temp.vPower1!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/1VPOWER", "set"));
            }
            break;
            case 64:
            if(tcm.temp.vPower18!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/18VPOWER", "set"));
            }
            break;
            case 65:
            if(tcm.temp.modeSettings!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/MODE_SETTINGS", "set"));
            }
            break;
            case 66:
            if(tcm.temp.laserDivider!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/LASER_DIVIDER", "set"));
            }
            break;
            case 67:
            if(tcm.temp.extSwitches!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/EXT_SW", "set"));
            }
            break;
            case 68:
            if(tcm.temp.attenuator!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/ATTENUATOR", "set"));
            }
            break;
            case 69:
            if(tcm.temp.triggerModes!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/MODE", "set"));
            }
            break;
            case 70:
            if(tcm.temp.dsTriggerMask!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/DATA_SEL_TRG_MASK", "set"));
            }
            break;
            case 71:
            if(tcm.temp.bcidOffset!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/BCID_OFFSET", "set"));
            }
            break;
            case 72:
            if(tcm.temp.dgTriggerMask!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/DG_TRG_RESPOND_MASK", "set"));
            }
            break;
            case 73:
            if(tcm.temp.systemId!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/RDH_FIELDS", "set"));
            }
            break;
            case 74:
            if(tcm.temp.trgPatternLSB!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_CONT_PATTERN_LSB", "set"));
            }
            break;
            case 75:
            if(tcm.temp.trgPatternMSB!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TRG_CONT_PATTERN_MSB", "set"));
            }
            break;
            case 76:
            if(tcm.temp.cruOrbit!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/CRU_ORBIT", "set"));
            }
            break;
            case 77:
            if(tcm.temp.cruBcFifos!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/CRU_BC", "set"));
            }
            break;
            case 78:
            if(tcm.temp.fifoCount!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/FIFO_COUNT", "set"));
            }
            break;
            case 79:
            if(tcm.temp.selFirstHitDroppedOrbit!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SEL_FIRST_HIT_DROPPED_ORBIT", "set"));
            }
            break;
            case 80:
            if(tcm.temp.selLastHitDroppedOrbit!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SEL_LAST_HIT_DROPPED_ORBIT", "set"));
            }
            break;
            case 81:
            if(tcm.temp.selHitsDropped!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/SEL_HITS_DROPPED", "set"));
            }
            break;
            case 82:
            if(tcm.temp.readoutRate!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/READOUT_RATE", "set"));
            }
            break;
            case 83:
            if(tcm.temp.IPbusFIFOdata!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/IPbus_FIFO_DATA", "set"));
            }
            break;
            case 84:
            if(tcm.temp.eventsCount!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/EVENTS_COUNT", "set"));
            }
            break;
            case 85:
            if(tcm.temp.mcodeTime!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/MCODE_TIME", "set"));
            }
            break;
            case 86:
            if(tcm.temp.fwTime!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/FW_TIME", "set"));
            }
            break;
            case 87:
            if(tcm.temp.dgBunchPattern!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/DG_BUNCH_PATTERN", "set"));
            }
            break;
            case 88:
            if(tcm.temp.tgSingleValue!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TG_SINGLE_VALUE", "set"));
            }
            break;
            case 89:
            ...
            if(tcm.temp.tgPattern0!=hexValue||firstTime||tgPattern1Changed){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TG_PATTERN", "set")); //do implementacji
            }
            break;
            case 91:
            if(tcm.temp.tgContValue!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/TG_CONT_VALUE", "set"));
            }
            break;
            case 92:
            if(tcm.temp.emulationRate!=hexValue||firstTime){
                ...
                Print::PrintInfo("sendCommand"+std::to_string(count));
                requests.push_back(make_pair("FIT_FRED/READOUTCARDS/TCM0/EMULATION_RATE", "set"));
            }
            break;
        }
        count+=1;
